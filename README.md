...
<table width="100%" style="border-collapse: collapse; border: none;">
  ...
  <tr>
    ...
    <td width="50%" valign="top" style="padding: 15px; border: 1px solid #e1e4e8; border-radius: 8px;">
      <h3>🛒 Myntra | CRM Migration & RFM Modeling</h3>
      <em>Project Business Analyst (Jan 2016 – Feb 2018)</em><br><br>
      Cleansed and standardized legacy customer datasets, successfully migrating 4 million rows into a newly established centralized CRM database[cite: 1]. Extracted and manipulated daily transactional data using advanced SQL to build RFM segmentation models[cite: 1].<br><br>
      <strong>Technologies & Skills:</strong><br>
      <code>Advanced SQL</code> <code>Excel Macros</code> <code>Data Migration</code> <code>CRM</code>[cite: 1]
    </td>
  </tr>
</table>
...
| :--- | :--- |
| **Methodologies** | Agile, Scrum, Kanban, Hybrid, Waterfall, Behavior-Driven Development (BDD)[cite: 1] |
| **Business Analysis** | Requirement Elicitation, BRDs/FSDs, User Stories (Gherkin), Process Mapping, Traceability[cite: 1] |
| **Tools & Tech** | Jira, Azure DevOps, Snowflake, Tableau, SQL, ServiceNow, Visio, LucidChart, Balsamiq[cite: 1] |
| **Domain Expertise** | Commercial Banking, Wealth Management, Clinical Workflows, API Integrations, HIPAA[cite: 1] |

---

## 🎓 Education & Certifications

* 🎓 **Master of Science in Business Analytics** | Western New England University, Springfield, MA[cite: 1]
* 📜 **Project Management Professional (PMP)** | Issued by PMI[cite: 1]
* 📜 **Generative AI for Project Managers**[cite: 1]
